...
- Gender is a factored variable - Male/Female, we will make this a numeric factor.  

- Senior Citizen is an int, we will make this a numeric factor. Partner is a factored variable Yes/No, we will make this a numeric factor.  

- Dependents is a factored variable Yes/No, we will make this a numeric factor.  

- Tenure is a continuous integer variable, no modification neccessary.

- Phone Service is a factored variable Yes/No, we will make this a numeric factor.  
...
- Internet Service is a factored variable with 3 levels, we will make this a numeric factor. This will be a bit of a challenge. 
...
- Contract is a factored variable with 3 levels, we will make this a numeric factor. This will be a bit of a challenge. 

- Paperless Billing is a factored variable Yes/No, we will make this a numeric factor. 

- Payment Method is a factored variable with 4 levels, we will make this a numeric factor. This will be a bit of a challenge. 

- Monthly Charges is a continuous numeric variable, no changes neccessary.
...
- Churn is a factored variable Yes/No, we will make this a numeric factor. This is our
dependent variable.
